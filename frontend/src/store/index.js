...
export default createStore({
  state: {
    ...
    ProductList: [
      ...
      { id: 3, name: 'Букет из разноцветных роз', url: '3.png', price: 800, pricesvg: 1000, pricebig: 2000, idprice: 0, new: true, rose: 10, tulip: 0, hydrangea: 5, gerber: 7, sunflower: 0, orchid: 8, iris: 0, lily: 7, package: 2, color: 0, popularity: 200, promotion: false },
      { id: 4, name: 'Букет из разноцветных роз', url: '4.png', price: 300, pricesvg: 1000, pricebig: 2000, idprice: 0, new: false, rose: 10, tulip: 0, hydrangea: 5, gerber: 7, sunflower: 0, orchid: 8, iris: 0, lily: 7, package: 2, color: 1, popularity: 150, promotion: false },
      { id: 5, name: 'Букет из разноцветных роз', url: '5.png', price: 500, pricesvg: 1000, pricebig: 2000, idprice: 0, new: false, rose: 10, tulip: 0, hydrangea: 5, gerber: 7, sunflower: 0, orchid: 8, iris: 0, lily: 7, package: 0, color: 1, popularity: 170, promotion: true },
      { id: 6, name: 'Букет из разноцветных роз', url: '6.png', price: 1000, pricesvg: 1000, pricebig: 2000, idprice: 0, new: false, rose: 10, tulip: 0, hydrangea: 5, gerber: 7, sunflower: 0, orchid: 8, iris: 0, lily: 7, package: 2, color: 1, popularity: 10, promotion: false },
      { id: 7, name: 'Букет из разноцветных роз', url: '7.png', price: 900, pricesvg: 1500, pricebig: 2000, idprice: 0, new: true, rose: 10, tulip: 0, hydrangea: 5, gerber: 7, sunflower: 0, orchid: 8, iris: 0, lily: 7, package: 0, color: 1, popularity: 10, promotion: false },
      { id: 8, name: 'Букет из разноцветных роз', url: '8.png', price: 1800, pricesvg: 2000, pricebig: 3000, idprice: 0, new: false, rose: 10, tulip: 0, hydrangea: 5, gerber: 7, sunflower: 0, orchid: 8, iris: 0, lily: 7, package: 0, color: 2, popularity: 1, promotion: false },
