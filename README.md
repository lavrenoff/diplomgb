...
Этот проект, разработанный мной в качестве дипломной работы по обучению на профессию "Frontend-разработчик". Данный репозиторий является frontend частью работы.
